...
**Текущий статус:**
- **Дипломный проект (Zynq-7000 SoC):** «Аппаратно-программная система высокоскоростного захвата и потокового сжатия тепловизионных данных стандарта MIPI CSI-2 на базе архитектуры Zynq».
